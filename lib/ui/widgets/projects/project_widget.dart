...
class ProjectWidget extends StatelessWidget {
    ...
    if (projectAlignment == ProjectAlignment.leftThumb) {
      return Row(
        ...
        children: [
          ...
          Expanded(child: _buildProjectDescription()),
        ],
      );
    } else {
      return Row(
    ...
    if (style == ProjectStyle.violet) {
      return baseDecoration.copyWith(
          gradient: LinearGradient(
            colors: [
              ColorConstants.highlightQueenViolet.withOpacity(0.50),
          ...
          colorFilter: ColorFilter.mode(
            ColorConstants.black.withOpacity(style == ProjectStyle.violet ? 0.29 : 32),
            BlendMode.dstATop,
          ),
        )
            : null,
      ...
      return baseDecoration.copyWith(
        ...
        gradient: LinearGradient(
          colors: [
            ColorConstants.textBlue.withOpacity(0.50),
            ColorConstants.deepTextBlue.withOpacity(0.48),
          ],
          begin: const FractionalOffset(0.0, 0.0),
          end: const FractionalOffset(1.0, 0.0),
          stops: const [0.0, 1.0],
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildBulletPoints(isRightAligned),
              const SizedBox(height: 32),
              _buildActionButton(),
            ],
          ),
  ...
  // Bullet points list
  Widget _buildBulletPoints(bool isRightAligned) {
    return Column(
