...
class ProjectsTab extends StatelessWidget {
  ...
  Widget _buildTopBarButton({
    ...
    required VoidCallback onHoverChanged,
          ...
          child: Row(
            children: [
              _buildTopBarButton(
                  ...
                  onHoverChanged: () =>
                      context.read<ProjectsCubit>().setTopBtnHovered(!state.topBtnHovered),
                  onTap: () => context.read<HomeCubit>().closeTab(2),
              ...
              _buildTopBarButton(
                  ...
                  onHoverChanged: () =>
                      context.read<ProjectsCubit>().setTopBtnHovered(!state.topBtnHovered),
                  onTap: () => context.read<HomeCubit>().minimizeTab(2),
    ...
    return Expanded(
      child: LayoutBuilder(
        builder: (context, constraints) {
          final scrollController = context.read<ProjectsCubit>().scrollController;
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        _buildComingSoonWidget(
                            isVisible: state.isComingSoonVisible),
                        const SizedBox(height: 16),
                      ],
                    ),
                  ),
  ...
  Widget _buildScrollToBottomButton({
    ...
    required ProjectsState state,
    required ScrollController scrollController,
    required BoxConstraints constraints,
  }) {
    final double scrollProgress = state.scrollProgress;
    final bool isAtBottom = scrollProgress == 1.0;
    ...
    return AnimatedPositioned(
      ...
      child: AnimatedOpacity(
        duration: const Duration(milliseconds: 300),
        opacity: state.isProject2Visible ? 1 : 0,
        curve: Curves.easeIn,
        child: InkWell(
          onTap: isAtBottom
              ? () => homeCubit.animateToBlog()
              : () => scrollController.animateTo(
                    scrollController.offset + constraints.maxHeight / 1.5,
  ...
  Widget _buildComingSoonWidget({required bool isVisible}) {
              ...
              child: Container(
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: Text("More Projects Coming Soon",
                        style: TextStyle(
